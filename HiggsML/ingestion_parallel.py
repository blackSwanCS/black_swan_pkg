...
from .systematics import systematics, get_bootstrapped_dataset, get_systematics_dataset
...
def _init_worker(using_tensorflow, pickled_model, device_queue, plugin_path):
    global _model
    ...
    # Load the module before unpickling.
    load_job_plugin(plugin_path)
